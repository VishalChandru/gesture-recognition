...
model = load_model('C:/Users/Ajit/Desktop/MAJOR PROJECT/project_kojak-master/models/VGG_cross_validated.h5')
...
while camera.isOpened():
    ...
    if isBgCaptured == 1:
        ...
        cv2.putText(thresh, f"Prediction: {prediction} ({score}%)", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (255, 255, 255))  # Add prediction and action text to thresholded image
    ...
    if k == 27:  # press ESC to exit all windows at any time
        ...
        if rover:
            if prediction == 'Palm':
                ...
                pass
##############
        params = urllib.parse.urlencode({'field1': action, 'key':api_key }) 
